<html lang="en"><head>
    ...
    <title>Xenox FX - Withdraw Log</title>
...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.1.0/js/bootstrap.min.js"></script>
    ...
    <div class="row">
    <div class="col-lg-6">
    <h2 class="page-title">Withdraw Log</h2>
    ...
    <a href="/withdraw" class="btn cmn-btn">
    Withdraw Now
    </a>
    </div>
    </div>
    ...
    <div class="col-lg-12 text-center">
        <a href="/dashboard"><img src="{{ url('/images/logo.png')}}" alt="image"></a>
