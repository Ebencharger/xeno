...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.1.0/js/bootstrap.min.js"></script>
    <title>Xenox FX - Transfer Balance</title>
    </head>
    <body>
    <div class="full-wh">
    ...
    <option value="2">Interest Wallet</option>
    </select>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
    <label>Amount <small class="text-success">( Charge: 10 USD + 15% )</small></label>
    ...
    <button class="btn btn-md w-100 cmn-btn">Transfer</button>
    </div>
    </form>
    </div>
    </div>
