...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.1.0/js/bootstrap.min.js"></script>
    ...
    <a class="site-logo site-title" href="/welcome"><img src="{{url('/images/logo.png')}}" alt="site-logo"></a>
    ...
    <a href="/dashboard/interestwallet" class="btn cmn-btn mb-md-0 mb-3">Deposit Wallet Transactions</a>
    <a href="" class="btn cmn-btn mb-md-0 btn-disabled">Interest Wallet Transactions</a>
    </div>
    </div>
    <div class="col-md-12">
    ...
    <a href="/welcome"><img src="{{url('/images/logo.png')}}" alt="image"></a>
    ...
    <p>© 2022 <a href="/dashboard/dashbaord" class="base--color">Xenox FX</a>. All rights reserved</p>
    </div>
    <div class="col-lg-6">
