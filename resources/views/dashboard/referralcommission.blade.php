<html lang="en"><head>
    ...
    <title>Xenox FX - Deposit Referral Commissions</title>
...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.1.0/js/bootstrap.min.js"></script>
    ...
    <a href="" class="btn cmn-btn mb-md-0 mb-2 btn-disabled">Deposit Commission</a>
    <a href="/dashboard/interestcommission" class="btn cmn-btn mb-md-0 mb-2">Interest Commission</a>
    <a href="/dashboard/investcommission" class="btn cmn-btn mb-md-0">Invest Commission</a>
    </div>
    </div>
    <div class="col-md-12">
