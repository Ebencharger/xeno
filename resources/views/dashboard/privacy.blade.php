...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.1.0/js/bootstrap.min.js"></script>
    <title>Xenox FX - Privacy Policy</title>
    </head>
    <body>
    <div class="full-wh">
    ...
    <div class="row">
    <div class="col-md-12">
    <p></p><h2 style="text-align:center;"><b>PRIVACY POLICY</b></h2><h2 style="margin-bottom:10px;font-weight:600;line-height:24px;font-size:24px;font-family:DauphinPlain;color:rgb(255,255,255);background-color:rgb(16,17,19);padding:0px;">
    </h2><p>Effective date: 2020-11-17</p>
    <p>1. <b>Introduction</b></p>
    <p>Welcome to <b> Xenox FX</b>.</p>
    <p><span style="font-size:0.875rem;">Our Privacy Policy governs your visit to </span><b style="font-size:0.875rem;">xenoxfx.com</b><span style="font-size:0.875rem;">, and explains how we collect, safeguard and disclose information that results from your use of our Service.</span><br></p>
    ...
    <p><b>SERVICE</b> means the xenoxfx.com website operated by Xenox FX.</p>
    ...
    <p>Xenox FX uses the collected data for various purposes:</p>
    ...
    <p>Xenox FX will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
    ...
    <p> If you wish to be informed what Personal Data we hold about you and if you want it to be removed from our systems, please email us at <b>admin@xenoxfx.com</b>.</p>
    ...
    <p>0.4. users are able to change their personal information by emailing us at <b>admin@xenoxfx.com</b>.</p>
    ...
    <p>To exercise your California data protection rights described above, please send your request(s) by email: <b>admin@xenoxfx.com</b>.</p>
    ...
    <p>If you have any questions about this Privacy Policy, please contact us by email: <b>admin@xenoxfx.com</b>.</p><p></p>
    </div>
    </div>
    </div>
    </section>
    ...
    <p></p><p>© 2022 <a href="/dashboard/dashboard" class="base--color">Xenox FX</a>. All rights reserved</p><p></p>
    </div>
    <div class="col-md-6">
