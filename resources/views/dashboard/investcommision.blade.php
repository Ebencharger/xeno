...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.1.0/js/bootstrap.min.js"></script>
    ...
    <title>Xenox FX - Invest Referral Commissions</title>
    </head>
    <body >
    <div class="full-wh">
    ...
    <a href="referralcommission" class="btn cmn-btn mb-md-0 mb-2">Deposit Commission
    </a>
    <a href="/dashboard/interestcommission" class="btn cmn-btn mb-md-0 mb-2">Interest Commission</a>
    <a href="" class="btn cmn-btn mb-md-0 btn-disabled ">
    Invest Commission
    </a>
    </div>
    </div>
