...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.1.0/js/bootstrap.min.js"></script>
    <title>Xenox FX - Interest Referral Commissions</title>
    </head>
    <body>
    ...
    <section class="inner-hero bg_img" data-background="{{url('/images/5fce3837032a51607350327.jpg')}}" style="background-image: url({{url('/images/fce3837032a51607350327.jpg')}})">
    <div class="container">
    <div class="row">
    <div class="col-lg-6">
    <h2 class="page-title">Interest Referral Commissions</h2>
    ...
    <a href="/dashboard/referralcommission" class="btn cmn-btn mb-md-0 mb-2">Deposit Commission</a>
    <a href="" class="btn cmn-btn mb-md-0 mb-2 btn-disabled">Interest Commission</a>
    <a href="/dashboard/investcommission" class="btn cmn-btn mb-md-0">Invest Commission
    </a>
    </div>
    </div>
    <div class="col-md-12">
