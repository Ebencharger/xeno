...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.1.0/js/bootstrap.min.js"></script>
    ...
    <div class="page-wrapper">
        ...
        <header class="header animated fadeInDown menu-fixed">
            ...
            <li class="icon"><a href="/signin"><i class="las la-user"></i></a></li>
            </ul>
    ...
    <div class="account-section bg_img" data-background="{{url('/images/5fce3a4f0b6131607350863.jpg')}}" style="background-image: url({{url('/images/5fce3a4f0b6131607350863.jpg')}}">
    <div class="container">
    <div class="row justify-content-center">
    <div class="col-xl-5 col-lg-7">
    <div class="account-card">
    <div class="account-card__header bg_img overlay--one" data-background="{{url('/images/5fce3a4f5d06e1607350863.jp')}}" style="background-image: url({{url('/images/5fce3a4f5d06e1607350863.jpg')}}">
    ...
    <option data-mobile_code="234" value="Nigeria" data-code="NG" selected="selected">Nigeria</option>
    ...
    <div style="height: 46px; line-height: 46px; width:100%; text-align: center; background-color: #003; color: #CCA354!important; font-size: 26px; font-weight: bold; letter-spacing: 20px; font-family: 'Henny Penny', cursive;  -webkit-user-select: none; -moz-user-select: none;-ms-user-select: none;user-select: none;  display: flex; justify-content: center;" class="captcha">
        <span style="    float:left;     -webkit-transform: rotate(-27deg);">3</span>
        <span style="    float:left;     -webkit-transform: rotate(-34deg);">7</span>
        <span style="    float:left;     -webkit-transform: rotate(-38deg);">6</span>
        <span style="    float:left;     -webkit-transform: rotate(16deg);">5</span>
        <span style="    float:left;     -webkit-transform: rotate(-13deg);">2</span>
        <span style="    float:left;     -webkit-transform: rotate(51deg);">8</span>
    </div>
    ...
    <a class="base--color" href="/dashboard/privacy"> Privacy Policy</a>
    ,
    <a class="base--color" href="/dashboard/terms"> Terms &amp; Condition</a>
    </span>
    </div>
    </div>
    <div class="mt-3">
    ...
    <div class="form-row mt-2">
    <div class="col-sm-6">
    <p class="f-size-14">Have an account? <a href="/signin" class="base--color">Login</a></p>
    </div>
    </div>
    </form>
    </div>
    ...
    <li><a href=""><i class="las la-facebook-f"></i></a></li>
    <li><a href=""><i class="las la-twitter"></i></a></li>
    <li><a href=""><i class="las la-pinterest-p"></i></a></li>
    <li><a href=""><i class="las la-linkedin-in"></i></a></li>
    </ul>
    </div>
    </div>
    </div>
